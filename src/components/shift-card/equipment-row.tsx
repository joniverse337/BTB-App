...
import type { ShiftEquipment } from '@/lib/validations/shift'
import { ActionChipPopover } from './action-chip-popover'

export function EquipmentRow({ equipment, onUpdate, onDelete, categories }: {
        ...
        <div ref={wrapRef} style={{ position: 'relative' }}>
          ...
          {showChips && (
            <ActionChipPopover
              ...
              onAdd={(cat) => { onUpdate(equipment.id, 'typ', cat); setLocalTyp(null) }}
